...
function isimb_6310_set_generate_json_data(
  ...
  myObj.tooltipWidth = jQuery(selector + ".isimb_6310_tooltip_width").val();
  ...
  myObj.pluginShortCodeBgColor = jQuery(
    selector + `input[name='isimb_6310_plugin_short_code_bg_color']`
  ).val();
  myObj.pluginShortCodeWidth = jQuery(
    selector + `input[name='isimb_6310_plugin_short_code_tooltip_width']`
  ).val();
  myObj.pluginShortCodePadding = jQuery(
    selector + `input[name='isimb_6310_plugin_short_code_tooltip_padding']`
  ).val();
...
function isimb_6310_set_json_data() {
  ...
  jQuery(".isimb_6310_tooltip_width").val(
    jsonData.tooltipWidth ? jsonData.tooltipWidth : 400
  );
  ...
  jQuery(`input[name='isimb_6310_plugin_short_code_bg_color']`).val(
    jsonData.pluginShortCodeBgColor
  );
  jQuery(`input[name='isimb_6310_plugin_short_code_tooltip_width']`).val(
    jsonData.pluginShortCodeWidth
  );

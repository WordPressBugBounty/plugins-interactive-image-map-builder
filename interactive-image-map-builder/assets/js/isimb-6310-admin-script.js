...
jQuery(window).load(function () {
  ...
  jQuery("body").on("change", ".isimb-6310-section-select", function () {
    ...
    jQuery(
      ".isimb-6310-tooltip-link, .isimb-6310-embided, .isimb-6310-external-link, .isimb-6310-templates, .isimb-6310-tooltip-img, .isimb_6310_custom_template, .isimb-6310-direct-link, .isimb-6310-link-content-direct, .isimb_6310_plugin_shortcode"
    ...
    if (val == 1) {
      ...
      jQuery(
        '.isimb_6310_font_prop, .isimb_6310_template_embedded, .toggle-tabs li[data-id="3"], .isimb_6310_template_description'
      ).addClass("isimb-6310-hide");
    } else if (val == 4) {
      jQuery(".isimb_6310_plugin_shortcode").removeClass("isimb-6310-hide");
      jQuery(
        '.isimb_6310_font_prop, .isimb_6310_template_embedded, .toggle-tabs li[data-id="3"], .isimb_6310_custom_template, .isimb_6310_template_description'
      ).addClass("isimb-6310-hide");
    } else {
      jQuery(
        '.toggle-tabs li[data-id="3"], .isimb-6310-direct-link, .isimb-6310_link, .isimb-6310_link-type, .isimb-6310-link-content-direct, .isimb_6310_plugin_shortcode'
      ).removeClass("isimb-6310-hide");
      jQuery(
...
function isimb_6310_tooltip_fields() {
  ...
  jQuery("body").on("change", 'select[name="tooltip_position"]', function () {
    const value = Number(jQuery(this).val());
    if (value && value !== 2 && value !== 5 && value !== 7) {
      jQuery(".tooltip-attribute").show();

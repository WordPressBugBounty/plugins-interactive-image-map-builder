...
[Live Demo](https://wpmart.org/interactive-svg-image-map-builder-demo/) | [Upgrade Pro](https://wpmart.org/downloads/interactive-svg-image-map-builder/) | [Support](https://wpmart.org/contact/)

= interactive image map plugin features video =
https://www.youtube.com/watch?v=KTcjvOB-LTY
...
https://www.youtube.com/watch?v=x_JkkRCplLE
...
In addition to selecting the region, you might need to move the area. Nothing to worry about! Drag the selected area as much as you like with our plugin. Upgrade our <a href="https://wpmart.org/downloads/interactive-svg-image-map-builder">Interactive-SVG-Image-Map-Builder Pro</a> Pro version to get more features and customization options.
...
== Usage: ==
1. Uploading the photograph is the first thing you need to do. It could be a product, a map, or any form of image, for example. You can mark or select the desired location on the product's image or map.
 
2. Now that you have the region you want to be precise, you need to style it with things like color, border color, size, box-shadow options, etc. To annotate or choose the area of the image, there are many options available. You may find these options under the "Area Style" section.
 
3. The content section is the next section of modification. You may find information about the various content view options under the content section. Tooltips and modals are the two ways to view the content.
 
4. You can use our pre-built templates or a custom template from one of the many custom template collections in the tooltip and modal content.
 
5. After choosing a template, you will see two options: "Add picture" where you can upload or add more in-depth photographs, and "Title" where the title of the selected region of the image will be shown. In addition to giving a description, you can alter the font style, color, and backdrop of the material.
 
6. Custom code may also be utilized in addition to templates by being styled in the manner that you like. You must write or paste our HTML code in the HTML area and our CSS code in the CSS code section to do this.
...
1. Tooltip template
2. Template with picture and URL
3. Custom Template
4. Tooltip template
5. Embedded code for video
6. Settings 1
7. Settings 2
8. Settings 4
...
= What is Interactive SVG Image Map Builder Plugin? =
This Interactive Image Map is the act of adding short explanations or notes to an image or parts of the image. Our plugin has an easy-to-use facility for adding canvas to any images, products, maps, etc. The canvas to literary texts makes them more accessible.
...
= Does this support Elementor, Gutenberg, Visual Composer, and WP Bakery? =
Yes, all common WordPress page builders are supported.
 
= Does the Interactive SVG Image Map Builder Wp plugin support Divi Theme, BeTheme, Avada Theme, and Astra Theme? =
Yes, It supports all popular WordPress themes.
 
= In which case we can be used it? =
This plugins have a wide range of applications, including displaying similar polling results, marking items and accessories to display information about them, marking or selecting a map region to display information about a specific location, and many more.
 
= Can the plugin content be used with a custom template? =
Yes, even if custom images or icons can be used for the tooltip content, you can utilize HTML and CSS for your unique template.
 
 = Is creating or choosing several sections or canvass inside a single image have any restrictions? =
There are no restrictions; you can produce as much as you like.
 
= Are there any restrictions on how to use the Draw/Image canvas WordPress Plugin? =
No, by using shortcodes, you can use as much as you like.
 
= Does it accept Custom CSS? =
It is possible to replace the current styles class with your own CSS values.

= How many area/polygon I can add in free version? =
...
= 2.8 =
* More option added for tooltip position 
...
= 2.1 =
* Zoom feature added
* Multiple tooltip position added

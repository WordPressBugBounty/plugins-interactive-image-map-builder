...
<?php
   ...
   function isimb_6310_load_templates($js, $counter, $ids) {
      ...
      if($js->elementType == '1' || $js->elementType == '2' || $js->elementType == '4'){        

         if($js->selectedTemplate == '01' || $js->elementType == '4') {
            if($js->linkText){
               echo "
                     {$modal_start}
               ...
               .{$className2}-element{
                  ...
                  padding: 5px 10px;
                  border-radius: 5px;
                  max-width: ".esc_attr(isset($js->tooltipWidth) ? $js->tooltipWidth : 200)."px !important;
               }  
         ...
         // $customCSS .= "@media screen and (max-width: 767px) {.isimb-6310-hover-content-{$ids}-{$counter}{display: none}}";   
            ...
            ";         
            $customCSS .= "
               .{$className2}-element .isimb-6310-template-03-hover-content{
            ...
            .{$className2}-element .isimb-6310-template-05-hover-content{
               width: ".esc_attr(isset($js->tooltipWidth) ? $js->tooltipWidth : 450)."px;
               background: ".esc_attr($js->tempCommonBgColor).";        
            }  
